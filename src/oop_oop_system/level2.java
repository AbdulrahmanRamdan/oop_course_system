    ...
    public void quiz1() {
        ...
        this.quiz2();}
         ...
         System.out.println("you should study hard and try again");
           System.out.println("the course content of level 2 is :");
read_q1() ;   }
        }
    public   void read_q1(){
try {
			Scanner scanner = new Scanner(new File("C:\\Users\\elamir\\Documents\\NetBeansProjects\\oop_oop_system/level2-1.txt"));
    ...
    public   void read_q2(){
try {
			Scanner scanner = new Scanner(new File("C:\\Users\\elamir\\Documents\\NetBeansProjects\\oop_oop_system/level2-2.txt"));
			while (scanner.hasNextLine()) {
				System.out.println(scanner.nextLine());
			}
			scanner.close();
    ...
    public void quiz2() {
        ...
        if(counter>=3){
        System.out.println("quiz 2 is passed");
        System.out.print("the result is :");
        System.out.print(counter);
        System.out.print("/5");System.out.println();
        this.quiz3();}
    ...
    public void quiz3() {
        ...
        if(counter>=3){
        System.out.println("quiz 3 is passed");
        System.out.print("the result is :");
        System.out.print(counter);
        System.out.print("/5");System.out.println();
        this.result(true);}
         ...
         System.out.println("you should study hard and try again");
              System.out.println("the course content is ");
      ...
      public   void read_q3(){
try {
			Scanner scanner = new Scanner(new File("C:\\Users\\elamir\\Documents\\NetBeansProjects\\oop_oop_system/level2-3.txt"));
			while (scanner.hasNextLine()) {
				System.out.println(scanner.nextLine());
			}
			scanner.close();
