...
System.out.println(this.explain);
    ...
    public void quiz1() {
        ...
        this.quiz2();}
         ...
         System.out.println("the conent of level 1 is");
    ...
    //level1
public   void read_level1(){
try {
			Scanner scanner = new Scanner(new File("C:\\Users\\elamir\\Documents\\NetBeansProjects\\oop_oop_system/1.txt"));
    ...
    public   void read_2(){
try {
			Scanner sc = new Scanner(new File("C:\\Users\\elamir\\Documents\\NetBeansProjects\\oop_oop_system/2.txt"));
...
read_3() ;   }
    ...
    public   void read_3(){
try {
			Scanner scanner = new Scanner(new File("C:\\Users\\elamir\\Documents\\NetBeansProjects\\oop_oop_system/3.txt"));
			while (scanner.hasNextLine()) {
				System.out.println(scanner.nextLine());
			}
			scanner.close();
